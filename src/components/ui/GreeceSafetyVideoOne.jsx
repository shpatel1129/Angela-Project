      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light mb-6">
            Bespoke Safety & Seamless Island Travel
          </h2>
          <p className="font-sans text-slate-300 font-light leading-relaxed">
            Discover how professional coordination, private transfers, and thoughtful pacing eliminate travel anxiety across the Greek islands.
          </p>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-slate-950">
              <iframe
                ...
                title="Greece Travel Safety Guide Video 1"
                frameBorder="0"
            ...
            <div className="mt-12 text-center max-w-2xl mx-auto border-t border-white/10 pt-8">
              <p className="font-display text-lg italic text-[#c9a15c] mb-3">
                "The biggest safety advantage on a luxury Greek vacation comes from intelligent itinerary design. Eliminate tight connections and let the destination unfold."
              </p>
...
export default GreeceSafetyVideoOne;
