      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light mb-6">
            Intelligent Summer Travel in Greece
          </h2>
          <p className="font-sans text-slate-300 font-light leading-relaxed">
            Discover how to experience the best of Greek summer while staying cool, avoiding crowds, and prioritizing high-comfort travel choices.
          </p>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-slate-950">
              <iframe
                ...
                src="https://www.youtube.com/embed/PlCPx9yETCo"
                title="Greece Luxury Travel Guide Video 1"
                frameBorder="0"
            ...
            <div className="mt-12 text-center max-w-2xl mx-auto border-t border-white/10 pt-8">
              <p className="font-display text-lg italic text-[#c9a15c] mb-3">
                "The secret of Greek summer is not to fight the heat, but to flow with it. Sail when it's hot, explore when it's cool."
              </p>
...
export default GreeceHeatVideoOne;
