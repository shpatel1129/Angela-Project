      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-10">
          <FadeIn>
            ...
            <h3 className="font-display text-2xl md:text-3xl text-slate-100">
              Silversea Expeditions: The Kimberley Coast
            </h3>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.2}>
          <div className="aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-800 bg-slate-900">
            <iframe
              src="https://www.youtube.com/embed/Mm6eujlY5c8"
              title="Official Silversea Kimberley Expedition"
              frameBorder="0"
...
export default KimberleyVideoEmbedOne;
