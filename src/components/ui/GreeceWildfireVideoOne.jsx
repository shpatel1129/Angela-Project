      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light mb-6">
            Understanding Greek Summer Weather Realities
          </h2>
          <p className="font-sans text-slate-300 font-light leading-relaxed">
            Gain an authentic, ground-level understanding of how microclimates, Meltemi winds, and Civil Protection keep island travelers safe.
          </p>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-slate-950">
              <iframe
                ...
                src="https://www.youtube.com/embed/BY2RUJdH2Is"
                title="Greece Travel Wildfire Safety Video 1"
                frameBorder="0"
            ...
            <div className="mt-12 text-center max-w-2xl mx-auto border-t border-white/10 pt-8">
              <p className="font-display text-lg italic text-[#c9a15c] mb-3">
                "Wildfires in Greece are seasonal, localized events—not countrywide catastrophes. Knowing which islands to visit and structuring your itinerary with built-in buffers makes all the difference."
              </p>
...
export default GreeceWildfireVideoOne;
