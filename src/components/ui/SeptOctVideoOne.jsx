      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light mb-6">
            The Magic of Shoulder Season in Greece
          </h2>
          <p className="font-sans text-slate-300 font-light leading-relaxed">
            Discover how September and October unlock unhurried elegance, gentle Mediterranean breezes, and exceptional private touring access.
          </p>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-slate-950">
              <iframe
                ...
                src="https://www.youtube.com/embed/8ebj2aR8Pig"
                title="September vs October Greece Video 1"
                frameBorder="0"
            ...
            <div className="mt-12 text-center max-w-2xl mx-auto border-t border-white/10 pt-8">
              <p className="font-display text-lg italic text-[#c9a15c] mb-3">
                "Shoulder season is when Greece belongs to the thoughtful traveler—when the sea is warm, the tables are open, and the sunset is yours."
              </p>
...
export default SeptOctVideoOne;
