...
import { Sun, Users, Flame, HelpCircle } from 'lucide-react';

const GreeceHeatDestinations = ({ destinations = [], images = [] }) => {
  return (
    <section id="heat-destinations" className="py-24 bg-white border-b border-slate-200">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="font-sans text-slate-600 font-light leading-relaxed">
            Not all destinations in Greece experience summer the same way. Explore how different islands and regions perform in peak season.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {destinations.map((d, idx) => {
            ...
            return (
              <FadeIn key={idx}>
                <div className="group h-[450px] relative rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 bg-navy-950 flex flex-col justify-end p-8 text-white">
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2.5 pt-2">
                      <span className="bg-white/10 backdrop-blur-md border border-white/15 px-3 py-1 rounded-full text-xs font-sans font-light flex items-center gap-1.5">
                        <Sun size={12} className="text-[#c9a15c]" />
                        Heat: {d.heat}
                      </span>
                      <span className="bg-white/10 backdrop-blur-md border border-white/15 px-3 py-1 rounded-full text-xs font-sans font-light flex items-center gap-1.5">
                        <Users size={12} className="text-[#c9a15c]" />
                        Crowds: {d.crowds}
                      </span>
                    </div>

                    {/* Expandable/Hover Tip Panel */}
...
export default GreeceHeatDestinations;
