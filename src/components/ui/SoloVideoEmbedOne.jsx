        ...
        <div className="text-center mb-10">
          <FadeIn>
            ...
            <h3 className="font-display text-2xl md:text-3xl text-slate-100">
              Discover Silversea: The Ultra-Luxury Cruise Experience
            </h3>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.2}>
          <div className="aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-800 bg-slate-900">
            <iframe
              ...
              title="Silversea Luxury Cruise Experience Overview"
              frameBorder="0"
...
export default SoloVideoEmbedOne;
