...
const AvalonReviewSnapshot = ({ data }) => {
  if (!data) return null;

  return (
    <section className="pt-16 md:pt-24 pb-8 md:pb-12 bg-ice-50 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mx-auto flex flex-col space-y-8">
          ...
          {/* Categories Grid (Top) */}
          <div className="bg-white shadow-xl shadow-navy-900/5 rounded-2xl p-8 border border-ice-100">
            <h3 className="font-display text-2xl text-navy-900 mb-8 border-b border-ice-100 pb-4 text-center">Category Ratings</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6">
              {data.categories.map((cat, idx) => (
                <div key={idx} className="flex flex-col items-center group space-y-2">
                  <span className="font-sans text-navy-800 text-base font-semibold group-hover:text-gold-600 transition-colors">{cat.name}</span>
          ...
          {/* Best For / Not Ideal For (Bottom) */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-navy-900 text-white shadow-xl shadow-navy-900/10 rounded-2xl p-8 flex flex-col">
              ...
              <ul className="space-y-4 font-sans text-sm md:text-base text-ice-50">
...
export default AvalonReviewSnapshot;
