      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <h2 className="font-display text-4xl md:text-5xl font-light mb-6">
            Discovering the Aegean Calendar
          </h2>
          <p className="font-sans text-slate-300 font-light leading-relaxed">
            See why timing dictates the spirit of your Greek holiday, from May wildflowers to golden September swimming warmth.
          </p>
        </div>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="relative aspect-video rounded-3xl overflow-hidden shadow-2xl border border-white/5 bg-slate-950">
              <iframe
                ...
                src="https://www.youtube.com/embed/lUdyapZEy1E"
                title="What is the Best Month to Visit Greece Video 1"
                frameBorder="0"
            ...
            <div className="mt-12 text-center max-w-2xl mx-auto border-t border-white/10 pt-8">
              <p className="font-display text-lg italic text-[#c9a15c] mb-3">
                "There is no single best month for everyone—only the month that aligns with what you came to experience."
              </p>
...
export default BestMonthVideoOne;
