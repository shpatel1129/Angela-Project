      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-10">
          <FadeIn>
            ...
            <h3 className="font-display text-2xl md:text-3xl text-slate-100">
              Inside the Silversea Fine Dining & Ambiance
            </h3>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.2}>
          <div className="aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-800 bg-slate-900">
            <iframe
              src="https://www.youtube.com/embed/HSUb4UEs0cE"
              title="Silversea Dining Experience & Onboard Ambiance"
              frameBorder="0"
...
export default DressVideoEmbedOne;
