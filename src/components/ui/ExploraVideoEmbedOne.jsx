...
const ExploraVideoEmbedOne = () => {
  return (
    <section className="w-full bg-slate-950 py-20 text-white relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-gold-400/3 rounded-full filter blur-3xl z-0"></div>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <div className="text-center mb-10">
          <FadeIn>
            ...
            <h3 className="font-display text-2xl md:text-3xl text-slate-100">
              Discover the Silversea Luxury Cruise Difference
            </h3>
          </FadeIn>
        </div>
        ...
        <FadeIn delay={0.2}>
          <div className="aspect-video w-full rounded-2xl overflow-hidden shadow-2xl border border-slate-800 bg-slate-900">
            <iframe
              src="https://www.youtube.com/embed/_eQokB6-aik"
...
export default ExploraVideoEmbedOne;
