...
const WindstarVsRiverVideo2 = ({ youtubeId, title, description }) => {
  return (
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            <FadeIn>
              ...
              <h3 className="font-display text-2xl sm:text-3xl font-bold leading-tight text-white mt-2">
                {title || "Specialty Venues & Dining Spotlights"}
              </h3>
              <p className="font-sans text-xs sm:text-sm text-ice-100/80 leading-relaxed mt-4">
                {description || "Explore what daily life looks like in detail. Compare the yachting freedom with river cruising's convenience and luxury service."}
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-5 mt-6">
                ...
                <ul className="space-y-2 font-sans text-xs text-ice-200">
                  <li className="flex items-center gap-2">
                    ...
                    <span>Yacht style freedom vs structured tours</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-ts-gold"></span>
                    <span>Casual elegance onboard dress codes</span>
                  </li>
                </ul>
              </div>
            </FadeIn>
            ...
            <FadeIn delay={0.1}>
              <div className="relative rounded-3xl overflow-hidden aspect-video bg-navy-900 border-2 border-ts-gold shadow-2xl">
                <iframe
                  ...
                  title="River Cruise Experience vs Ocean Cruise"
                  frameBorder="0"
...
export default WindstarVsRiverVideo2;
