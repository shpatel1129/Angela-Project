...
const RcaVideo1 = ({ youtubeId, title, description }) => {
  if (!youtubeId) return null;

  return (
    <section className="w-full py-20 bg-navy-950 text-white relative overflow-hidden">
      {/* Dynamic graphic grids */}
      <div className="absolute right-0 bottom-0 w-80 h-80 bg-white/[0.01] rounded-tl-full pointer-events-none"></div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <FadeIn direction="right">
              ...
              <p className="font-sans text-xs sm:text-sm text-slate-350 leading-relaxed font-light">
                {description || "Explore the sophisticated interior architecture, elegant public lounges, and Michelin-inspired culinary venues of the Regent fleet."}
              </p>
