...
const RciVideo1 = ({ youtubeId, title, description }) => {
    ...
    <section className="w-full py-20 bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Left Column: Video Narrative (cols 1-5) */}
          <div className="lg:col-span-5 space-y-6">
            <FadeIn direction="right">
              ...
              <h3 className="font-display text-2xl sm:text-3xl font-bold leading-tight">
                {title || "Luxury Onboard Experience"}
              </h3>
          ...
          {/* Right Column: Video Player Container (cols 6-12) */}
