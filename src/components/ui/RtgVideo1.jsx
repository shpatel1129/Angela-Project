...
const RtgVideo1 = ({ youtubeId, title, description }) => {
    ...
    <section className="w-full py-20 bg-navy-950 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.02] pointer-events-none">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <line x1="15%" y1="0" x2="15%" y2="100%" stroke="#fff" strokeWidth="1" />
          <line x1="85%" y1="0" x2="85%" y2="100%" stroke="#fff" strokeWidth="1" />
        </svg>
      </div>
      ...
      <div className="max-w-[1280px] mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          {/* Right Column: Video Container (cols 6-12) */}
